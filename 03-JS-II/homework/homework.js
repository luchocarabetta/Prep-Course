...
function obtenerMayor(x, y) {
  ...
  // Tu código:
  if (x > y) return x; else (x < y); return y;
}
...
function fizzBuzz(numero) {
  ...
  if (numero % 3 === 0 && numero % 5 === 0) {return 'fizzbuzz';} else if
  (numero % 3 === 0) {return 'fizz';} else if (numero % 5 === 0) {return 'buzz';} else {return numero}
}
...
function esPrimo(numero) {
  ...
  // Una forma puede ser  if( numero < 2) return false;
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
  let tabladelseis = [] 
  for (let i = 0; i < 11; i++) {tabladelseis.push(6*i)
 } return tabladelseis
}
